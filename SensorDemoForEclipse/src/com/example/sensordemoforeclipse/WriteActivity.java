...
//    }
    ...
    public void onConnectFailed(int i) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(WriteActivity.this, "Connect failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onConnectSuccess() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(WriteActivity.this, "Connect success", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onWriteSuccess() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(WriteActivity.this, "write success", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onWriteFailure(int i) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(WriteActivity.this, "write failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
